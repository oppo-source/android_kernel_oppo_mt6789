...
extern struct IMGSENSOR_HW_CFG imgsensor_bluey_config[];
extern struct IMGSENSOR_HW_CFG imgsensor_sonic_config[];
extern struct IMGSENSOR_HW_CFG imgsensor_24267_config[];
extern struct IMGSENSOR_HW_CFG imgsensor_fiji_config[];
