...
//bluey
UINT32 HI846_MIPI_RAW_MAIN_BLUEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 HI556_MIPI_RAW_SONIC_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//sonic-s
UINT32 HI846_MIPI_RAW_24695_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 HI556_MIPI_RAW_24695_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//fiji
UINT32 SC520CS_MIPI_RAW_MAIN_FIJI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
