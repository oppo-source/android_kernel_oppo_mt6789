...
struct IMGSENSOR_HW_CFG imgsensor_bluey_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_sonic_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_24267_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
			IMGSENSOR_I2C_DEV_0,
			{
...
struct IMGSENSOR_HW_CFG imgsensor_fiji_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
