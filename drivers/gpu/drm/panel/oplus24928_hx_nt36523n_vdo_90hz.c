...
static inline struct hx *panel_to_hx(struct drm_panel *panel)
{
	return container_of(panel, struct hx, panel);
}

#ifdef PANEL_SUPPORT_READBACK
static int hx_dcs_read(struct hx *ctx, u8 cmd, void *data, size_t len)
{
...
static void hx_panel_get_data(struct hx *ctx)
{
	u8 buffer[3] = { 0 };
	static int ret;
	...
	if (ret == 0) {
		ret = hx_dcs_read(ctx, 0x0A, buffer, 1);
...
static void hx_init_write_by_type(struct hx *ctx, struct LCM_setting_table_by_type *setting)
{
	struct mipi_dsi_device *dsi = to_mipi_dsi_device(ctx->dev);
	ssize_t ret = 0;
...
static unsigned int backlight_mapping_buf[] = {
	   0,  284,  290,  300,  320,  348,  364,  380,  396,  412,  428,  444,  460,  476,  492,  508,  524,  540,  555,  570,
...
struct LCM_setting_table_by_type lcd_init_on[] = {
	...
	/* APL_THD */
	{TYPE_DCS, 0x02, {0x11, 0x01}},
	{TYPE_DCS, 0x02, {0x12, 0x68}},
	/* APL_COMP */
	{TYPE_DCS, 0x02, {0x15, 0xE9}},
	{TYPE_DCS, 0x02, {0x16, 0x0C}},
	...
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x24, 0x02}},

	{TYPE_DCS, 0x02, {0xFF, 0xE0}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x14, 0x60}},
	{TYPE_DCS, 0x02, {0x16, 0xC0}},

	{TYPE_DCS, 0x02, {0xFF, 0x24}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x3B, 0x8F}},
	{TYPE_DCS, 0x02, {0x4B, 0x8F}},
	{TYPE_DCS, 0x02, {0x5B, 0x87}},
	{TYPE_DCS, 0x02, {0x92, 0xA2}},
	{TYPE_DCS, 0x02, {0xAA, 0xA2}},
	{TYPE_DCS, 0x02, {0xDC, 0xA2}},
	{TYPE_DCS, 0x02, {0xE0, 0xA2}},
	{TYPE_DCS, 0x02, {0xE2, 0xA2}},
	{TYPE_DCS, 0x02, {0xE4, 0xA2}},
	{TYPE_DCS, 0x02, {0xE6, 0xA2}},
	{TYPE_DCS, 0x02, {0xF0, 0xA2}},

	{TYPE_DCS, 0x02, {0xFF, 0x25}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x20, 0x67}},
	{TYPE_DCS, 0x02, {0x27, 0x8F}},
	{TYPE_DCS, 0x02, {0x45, 0x8F}},
	{TYPE_DCS, 0x02, {0x49, 0x67}},
	{TYPE_DCS, 0x02, {0x5E, 0x8F}},
	{TYPE_DCS, 0x02, {0x62, 0x67}},

	{TYPE_DCS, 0x02, {0xFF, 0x26}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x0C, 0x05}},
	{TYPE_DCS, 0x02, {0x12, 0x51}},
	{TYPE_DCS, 0x02, {0x13, 0x40}},
	{TYPE_DCS, 0x02, {0x14, 0x40}},
	{TYPE_DCS, 0x02, {0x16, 0x11}},
	{TYPE_DCS, 0x02, {0x19, 0x28}},
	{TYPE_DCS, 0x02, {0x1A, 0xC0}},
	{TYPE_DCS, 0x02, {0x1B, 0x25}},
	{TYPE_DCS, 0x02, {0x1C, 0x3D}},
	{TYPE_DCS, 0x02, {0x1E, 0xA2}},
	{TYPE_DCS, 0x02, {0x1F, 0xA2}},
	{TYPE_DCS, 0x02, {0x2A, 0x28}},
	{TYPE_DCS, 0x02, {0x2B, 0xC0}},
	{TYPE_DCS, 0x02, {0x32, 0xA2}},
	{TYPE_DCS, 0x02, {0x3A, 0xA2}},
	{TYPE_DCS, 0x03, {0xA9, 0x3F, 0x01}},
	{TYPE_DCS, 0x03, {0xAA, 0x3E, 0x01}},
	{TYPE_DCS, 0x03, {0xAB, 0x3D, 0x01}},
	{TYPE_DCS, 0x03, {0xAC, 0x3C, 0x01}},
	{TYPE_DCS, 0x03, {0xAD, 0x3B, 0x01}},
	{TYPE_DCS, 0x03, {0xAE, 0x3A, 0x01}},
	{TYPE_DCS, 0x03, {0xAF, 0x39, 0x01}},
	{TYPE_DCS, 0x03, {0xB0, 0x38, 0x01}},
	{TYPE_DCS, 0x03, {0xB1, 0x37, 0x01}},
	{TYPE_DCS, 0x03, {0xB2, 0x36, 0x01}},
	{TYPE_DCS, 0x03, {0xB3, 0x35, 0x01}},
	{TYPE_DCS, 0x03, {0xB4, 0x34, 0x01}},
	{TYPE_DCS, 0x03, {0xB5, 0x33, 0x01}},

	{TYPE_DCS, 0x02, {0xFF, 0x2A}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x25, 0xA2}},

	{TYPE_DCS, 0x02, {0xFF, 0x27}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x13, 0x00}},

	{TYPE_DCS, 0x02, {0xFF, 0x24}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x5C, 0x8F}},
	{TYPE_DCS, 0x02, {0x5D, 0x00}},

	/* 50218_Update */
	{TYPE_DCS, 0x02, {0xFF, 0x26}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x25, 0x20}},
	{TYPE_DCS, 0x02, {0x2F, 0x0B}},
	{TYPE_DCS, 0x02, {0x30, 0xCB}},
	{TYPE_DCS, 0x02, {0x33, 0x66}},
	{TYPE_DCS, 0x02, {0x34, 0x66}},
	{TYPE_DCS, 0x02, {0x35, 0x66}},
	{TYPE_DCS, 0x02, {0x36, 0x66}},
	{TYPE_DCS, 0x02, {0x37, 0x66}},
	{TYPE_DCS, 0x02, {0x38, 0x06}},

	{TYPE_DCS, 0x02, {0xFF, 0x27}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x14, 0x11}},

	{TYPE_DCS, 0x02, {0xFF, 0x26}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0xC9, 0x00}},

	/* 50220_Update */
	{TYPE_DCS, 0x02, {0xFF, 0x26}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x0F, 0x03}},
	{TYPE_DCS, 0x02, {0x16, 0x91}},
	{TYPE_DCS, 0x02, {0x06, 0xA0}},
	{TYPE_DCS, 0x02, {0x39, 0x05}},

	{TYPE_DCS, 0x02, {0xFF, 0x26}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x04, {0x3D, 0x00, 0x00, 0x80}},

	{TYPE_DCS, 0x02, {0xFF, 0x27}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	{TYPE_DCS, 0x02, {0x58, 0x80}},
	{TYPE_DCS, 0x02, {0x59, 0x01}},
	{TYPE_DCS, 0x02, {0x5A, 0x00}},
	{TYPE_DCS, 0x02, {0x5B, 0x01}},
	{TYPE_DCS, 0x02, {0x5C, 0x00}},
	{TYPE_DCS, 0x02, {0x5D, 0x7F}},
	{TYPE_DCS, 0x02, {0x5E, 0x7F}},
	{TYPE_DCS, 0x02, {0x5F, 0x00}},
	{TYPE_DCS, 0x02, {0x60, 0x00}},
	{TYPE_DCS, 0x02, {0x61, 0xFF}},
	{TYPE_DCS, 0x02, {0x62, 0xFF}},
	{TYPE_DCS, 0x02, {0x63, 0x03}},
	{TYPE_DCS, 0x02, {0x64, 0x34}},
	{TYPE_DCS, 0x02, {0x65, 0xFE}},
	{TYPE_DCS, 0x02, {0x66, 0xFF}},
	{TYPE_DCS, 0x02, {0x67, 0x03}},
	{TYPE_DCS, 0x02, {0x68, 0x34}},
	/*esd config*/
	{TYPE_DCS, 0x02, {0xFF, 0x26}},
	{TYPE_DCS, 0x02, {0xFB, 0x01}},
	...
	{TYPE_DCS, 0x11, {0x91, 0x89, 0xA8, 0x00, 0x14, 0xD2, 0x00, 0x02, 0x45, 0x01, 0xEC, 0x00, 0x08, 0x05, 0x7A, 0x04, 0x94}},
	{TYPE_DCS, 0x02, {0x92, 0x10, 0xF0}},
	{TYPE_DCS, 0x02, {0xB2, 0x80}},
	{TYPE_DCS, 0x02, {0xB3, 0x00}},
	{TYPE_DCS, 0x02, {0xBB, 0x13}},
	{TYPE_DCS, 0x07, {0x3B, 0x03, 0x10, 0x1E, 0x04, 0x04, 0x00}},
	{TYPE_DCS, 0x01, {0x11}},
	{TYPE_MDELAY, 100, {}},
	{TYPE_DCS, 0x01, {0x29}},
	{TYPE_MDELAY, 20, {}},
...
static void hx_panel_init_on(struct hx *ctx)
{
	int i= 0;
	...
	for (i = 0; i < sizeof(lcd_init_on) / sizeof(struct LCM_setting_table_by_type); i++) {
		hx_init_write_by_type(ctx, &lcd_init_on[i]);
	}

	printk("[lcd_info]%s -\n", __func__);
}

static void hx_panel_init_off(struct hx *ctx)
{
	int i= 0;
	...
	for (i = 0; i < sizeof(lcd_init_off) / sizeof(struct LCM_setting_table_by_type); i++) {
		hx_init_write_by_type(ctx, &lcd_init_off[i]);
	}
...
static int lcm_backlight_ic_config(struct device *pdev, int enable)
{
	...
	if (enable) {
		...
		/* Backlight Full-scale LED Current 23.6mA/CH；*/
		lcd_bl_write_byte(0x15, 0xB8);
...
{
	struct hx *ctx = panel_to_hx(panel);
	...
	if (en) {
		...
		if (esd_flag || shut_down_flag || (!tp_gusture_mode)) {
			printk("[lcd_info]%s:trigger esd, shutdown, tp gesture disable, lcm reset off\n", __func__);
			gpiod_set_value(ctx->reset_gpio,0);
		} else {
...
static int hx_disable(struct drm_panel *panel)
{
	struct hx *ctx = panel_to_hx(panel);
...
static int hx_unprepare(struct drm_panel *panel)
{
	...
	hx_panel_init_off(ctx);

	pr_err("lcm_suspend_power, esd_flag:%d, shut_down_flag:%d, tp_gusture_mode:%d\n", esd_flag, shut_down_flag, tp_gusture_mode);
	if (esd_flag || shut_down_flag || (!tp_gusture_mode)) {
		pr_err("[LCM] trigger esd power off, doing shutdown, tp gesture disable\n");
...
static int hx_prepare(struct drm_panel *panel)
{
	struct hx *ctx = panel_to_hx(panel);
	int ret;
	int blank;
	...
	if (esd_flag || (!tp_gusture_mode)) {
		pr_info("[LCM] in dis_panel_power_on,esd_flag:%d, tp_gusture_mode:%d\n", esd_flag, tp_gusture_mode);
	...
	ctx->prepared = true;
#ifdef PANEL_SUPPORT_READBACK
	hx_panel_get_data(ctx);
#endif
	pr_info("%s-\n", __func__);
	return ret;
}

static int hx_enable(struct drm_panel *panel)
{
	struct hx *ctx = panel_to_hx(panel);
...
//	.vfp_low_power = 1298,
	...
	.vendor = "24928_NT36523N",
        .manufacture = "24928_hx",
};
...
static int hx_setbacklight_cmdq(void *dsi, dcs_write_gce cb, void *handle,
				 unsigned int level)
{
	...
	if (level) {
		if (flag) {
			flag = false;
			mdelay(20);
			pr_info("hx_setbacklight_cmdq first set bl delay 20ms level = %d", level);
		}
	} else {
		flag = true;
	}
...
static void hx_cabc_mode_switch(void *dsi, dcs_write_gce cb,
...
{
	struct hx *ctx = container_of(panel, struct hx, panel);
	int ret = 0;

	if(gpiod_get_value(ctx->esd_te_gpio) || gpiod_get_value(ctx->esd_te1_gpio)) {
		pr_err("[ESD]%s: triger esd to recovery, esd-te=%d, esd-te1=%d\n", __func__, gpiod_get_value(ctx->esd_te_gpio), gpiod_get_value(ctx->esd_te1_gpio));
		esd_flag = true;
		ret = 1;
	} else {
		esd_flag = false;
...
static struct mtk_panel_funcs ext_funcs = {
	...
	.set_backlight_cmdq = hx_setbacklight_cmdq,
	.ext_param_set = mtk_panel_ext_param_set,
	.panel_poweron = lcm_panel_poweron,
	.cabc_switch = hx_cabc_mode_switch,
...
static int hx_get_modes(struct drm_panel *panel,
					struct drm_connector *connector)
{
	...
	connector->display_info.width_mm = 121;
	connector->display_info.height_mm = 215;

	pr_info("%s-- \n", __func__);
	return 1;
}

static const struct drm_panel_funcs hx_drm_funcs = {
	.disable = hx_disable,
	.unprepare = hx_unprepare,
	.prepare = hx_prepare,
	.enable = hx_enable,
	.get_modes = hx_get_modes,
};

static int hx_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s+ hx,nt36523n,vdo,90hz\n", __func__);
	...
	ctx = devm_kzalloc(dev, sizeof(struct hx), GFP_KERNEL);
	if (!ctx)
		return -ENOMEM;
	...
	ctx->esd_te1_gpio = devm_gpiod_get(ctx->dev, "esd-te1", GPIOD_IN);
	if (IS_ERR(ctx->esd_te1_gpio)) {
		dev_info(dev,"[lcd_info]cannot get esd_te1_gpio %ld\n",
			PTR_ERR(ctx->esd_te1_gpio));
		return PTR_ERR(ctx->esd_te1_gpio);
	}
	gpiod_direction_input(ctx->esd_te1_gpio);

	ctx->prepared = true;
	ctx->enabled = true;
	drm_panel_init(&ctx->panel, dev, &hx_drm_funcs, DRM_MODE_CONNECTOR_DSI);
	...
	mode = get_boot_mode();
       //add proc/devinfo/lcd
        register_device_proc("lcd", "24928_NT36523N", "24928_hx");
...
static int hx_remove(struct mipi_dsi_device *dsi)
{
	struct hx *ctx = mipi_dsi_get_drvdata(dsi);
#if defined(CONFIG_MTK_PANEL_EXT)
...
static const struct of_device_id hx_of_match[] = {
	{
		.compatible = "hx,nt36523n,vdo,90hz",
	},
	{}
};

MODULE_DEVICE_TABLE(of, hx_of_match);

static struct mipi_dsi_driver hx_driver = {
	.probe = hx_probe,
	.remove = hx_remove,
	.driver = {
		.name = "oplus24928_hx_nt36523n_vdo_90hz",
		.owner = THIS_MODULE,
		.of_match_table = hx_of_match,
	},
};

module_mipi_dsi_driver(hx_driver);

MODULE_AUTHOR("lixiangyang <lixiangyang@huaqin.com>");
MODULE_DESCRIPTION("HX NT36523N VDO 90HZ LCD Panel Driver");
