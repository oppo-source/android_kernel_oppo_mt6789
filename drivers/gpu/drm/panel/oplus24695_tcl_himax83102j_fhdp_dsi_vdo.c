...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	tianma_dcs_write_seq_static(ctx, 0xD9, 0xD4);
	...
	tianma_dcs_write_seq_static(ctx, 0xE7, 0x0F,0x0F,0x0F,0x22,0x29,0x70,0x01,0x2A,0x70,0x14,0x14,0x00,0x00,0x00,0x00,0x12,0x05,0x02,0x02,0x00,0x33,0x03,0x84);
...
static const struct drm_display_mode performance_mode_48hz = {
	...
	.htotal = 1200 + HFP + HSA + HBP,/* 60 20 40 HBP*/
	.vdisplay = 1920,
	.vsync_start = 1920 + VFP48,/* 1810 48FPS */
	.vsync_end = 1920 + VFP48 + VSA,//VSA
	.vtotal = 1920 + VFP48 + VSA + VBP,/* 1810 8 12 VBP*/
};
#endif
...
static int tianma_probe(struct mipi_dsi_device *dsi)
{
	...
	if (ret < 0)
		...
		ext_params_48hz.round_corner_en = value;
#endif
	}
